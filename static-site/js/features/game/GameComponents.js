...
const CARD_STYLE_MAP = {
    'Individual Impact':   { background: '/svg/CRC_Individual_Text.svg',   textColor: '#d8e7e1' },
    'Social Impact':       { background: '/svg/CRC_Social_Text.svg',        textColor: '#3c3a34' },
    'Environmental Impact':{ background: '/svg/CRC_Environmental_Text.svg', textColor: '#352c1a' },
};
...
const FAN_CARDS = [
    { src: '/svg/CRC_Individual_Design.svg',    rotate: -30, z: 10, marginStyle: 'margin-right: -48px;' },
    { src: '/svg/CRC_Social_Design.svg',         rotate:   0, z: 20, marginStyle: '' },
    { src: '/svg/CRC_Environmental_Design.svg',  rotate:  30, z: 10, marginStyle: 'margin-left: -48px;' },
];
